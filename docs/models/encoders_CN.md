...
| `biovil` | BioViL: Multi-Modal Vision-Language Pre-Training | ECCV 2022 | - | 未提供 |
| `chexzero` | CheXzero: Expert-level disease detection | Nat Mach Intel 2023 | - | 未提供 |
...
| `endo_fm` | Endo-FM | 2024 | - | 未提供 |
| `surgical_sam` | Surgical-SAM | 2024 | - | 未提供 |
...
| MiT 原生（预训练） | `mit_b0` ~ `mit_b5`, `segformer_mit` | [segformer_b0.yaml](../../configs/architectures/networks/general/segformer_b0.yaml) |
