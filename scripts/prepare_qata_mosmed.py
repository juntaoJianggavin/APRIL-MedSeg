...
def main():
    ...
    if ok:
        ...
        if args.dataset == "qata":
            ...
            print(f"    python train_text_guided.py --config configs/training_paradigms/text_guided/qata_covid19_lvit.yaml")
        else:
            print(f"    python train_text_guided.py --config configs/training_paradigms/text_guided/mosmed_plus_languide.yaml")
            print(f"    python train_text_guided.py --config configs/training_paradigms/text_guided/mosmed_plus_lvit.yaml")
    else:
